...
import com.gromo.masterdetailshowcase.core.navigation.api_impl.EpisodeDetailsNavigationImpl
...
val navigationModule = module {
    ...
    singleOf(::EpisodeDetailsNavigationImpl) {
        bind<EpisodeDetailsNavigation>()
    }
}
